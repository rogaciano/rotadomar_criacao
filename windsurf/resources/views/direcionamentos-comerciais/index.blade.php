                    ...
                    <div class="mb-6 bg-slate-100/50 dark:bg-slate-800/50 p-6 rounded-xl border border-slate-200 dark:border-slate-800">
                        <form action="{{ route('direcionamentos-comerciais.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="descricao" id="descricao" value="{{ request('descricao') }}" class="w-full rounded-xl border-slate-300 dark:border-slate-700 shadow-sm focus:border-primary-500 focus:ring focus:ring-primary-200 focus:ring-opacity-50" placeholder="Digite a descrição">
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center mt-2">
                                    ...
                                    <label for="incluir_excluidos" class="ml-2 block text-sm text-slate-600 dark:text-slate-400">Mostrar excluídos</label>
                                </div>
                            </div>
