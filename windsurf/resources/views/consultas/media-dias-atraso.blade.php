<x-app-layout>
    ...
    <div class="py-12 bg-gray-900">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-600">Este relatório mostra a média de dias úteis que os produtos permanecem em cada localização para movimentações não concluídas.</p>
                    </div>
                    
                    <!-- Loading Animation -->
                    <div id="loading-animation" class="flex flex-col items-center justify-center py-12">
                        <div class="animate-spin rounded-full h-32 w-32 border-t-2 border-b-2 border-blue-500 mb-4"></div>
                        <h3 class="text-xl font-semibold text-gray-700">Processando dados...</h3>
            ...
            <div id="localizacoes-inativas" class="bg-white overflow-hidden shadow-sm sm:rounded-lg hidden">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(function() {
                ...
                // Mostrar localizações inativas se existirem
                const localizacoesInativas = document.getElementById('localizacoes-inativas');
                if (localizacoesInativas) {
                    localizacoesInativas.classList.remove('hidden');
                }
            ...
            document.getElementById('exportPdfBtn').addEventListener('click', function() {
                ...
                // Remover a animação de carregamento do clone
                const loadingAnimation = elementClone.querySelector('#loading-animation');
                if (loadingAnimation) {
