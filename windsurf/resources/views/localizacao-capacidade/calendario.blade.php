    ...
    <div class="py-12 bg-gray-900">
        <div class="max-w-screen-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap gap-2 mb-4">
                <a href="{{ route('localizacao-capacidade.dashboard', ['mes' => $mes, 'ano' => $ano, 'localizacao_id' => $localizacaoId]) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    <form method="GET" action="{{ route('localizacao-capacidade.calendario') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
            ...
            <div class="flex justify-between mt-4">
                ...
                @endphp
                <a href="{{ route('localizacao-capacidade.calendario', ['mes' => $mesAnterior, 'ano' => $anoAnterior, 'localizacao_id' => $localizacaoId]) }}"
                ...
                <a href="{{ route('localizacao-capacidade.calendario', ['mes' => $mesProximo, 'ano' => $anoProximo, 'localizacao_id' => $localizacaoId]) }}"
                   class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    Próximo Mês
