                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('permissions.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="display_name" id="display_name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('display_name') border-red-500 @enderror" value="{{ old('display_name') }}" required>
                            @error('display_name')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
                        </div>
