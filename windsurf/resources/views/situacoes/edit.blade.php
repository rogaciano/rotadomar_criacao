                ...
                <form action="{{ route('situacoes.update', $situacao->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="ativo" value="1" class="rounded border-gray-300 dark:border-slate-600 dark:bg-slate-800 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ $situacao->ativo ? 'checked' : '' }}>
