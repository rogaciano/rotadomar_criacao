    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('marcas.edit', $marca) }}" class="btn-ghost-warning">
                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row md:justify-between md:items-start">
                        ...
                        <div class="mt-6 md:mt-0 md:w-1/3 md:flex md:justify-end">
                            <a href="{{ route('produtos.index', ['marca' => $marca->nome_marca]) }}" class="btn-ghost-primary w-full md:w-auto justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
