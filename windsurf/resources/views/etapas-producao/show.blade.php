            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div class="bg-indigo-50 p-4 rounded-lg md:col-span-4">
                            <p class="text-xs text-indigo-500 uppercase font-bold">Setor para Notificação</p>
                            @if($etapa->setor)
                                <div class="flex items-center gap-2 mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                                    </svg>
                                    <p class="text-lg font-bold text-indigo-900">{{ $etapa->setor->nome_localizacao }} ({{ $etapa->setor->nome_reduzido }})</p>
                                </div>
                                <p class="text-xs text-indigo-600 mt-1 italic">Usuários deste setor serão notificados ao entrar nesta etapa.</p>
                            @else
                                <p class="text-gray-500 mt-1 italic">Nenhum setor configurado para notificações.</p>
                            @endif
                        </div>
                    </div>
                </div>
