        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('grupo-produtos.update', $grupoProduto) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="grupo_produto" class="block mt-1 w-full" type="text" name="grupo_produto" :value="old('grupo_produto', $grupoProduto->grupo_produto)" required autofocus />
                            ...
                            <div>
                                ...
                                <select id="ativo" name="ativo" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <option value="1" {{ old('ativo', $grupoProduto->ativo) == '1' ? 'selected' : '' }}>Ativo</option>
                                    <option value="0" {{ old('ativo', $grupoProduto->ativo) == '0' ? 'selected' : '' }}>Inativo</option>
                                </select>
