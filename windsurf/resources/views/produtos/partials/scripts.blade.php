        ...
        $(document).ready(function() {
            ...
            function renderCores(cores) {
                ...
                cores.forEach(function(cor) {
                    ...
                    const borderColor = cor.tipo === 'existente' 
                    ...
                    const labelColor = cor.tipo === 'existente' ? 'text-green-700 dark:text-green-400' : 'text-blue-700 dark:text-blue-400';
                        ...
                        <div class="mb-3 p-3 border ${borderColor} rounded-md">
                            <div class="flex flex-col space-y-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <label class="text-sm text-gray-700 dark:text-gray-300">Quantidade:</label>
                                        <input type="number"
                                ...
                                <div class="border-t border-gray-200 dark:border-gray-700 pt-3">
                                    <table class="w-full text-sm text-gray-700 dark:text-gray-300">
                                        <tr>
                                            <td class="pr-2"><span class="font-medium">Estoque:</span></td>
                                            <td class="pr-4 text-gray-900 dark:text-gray-200">${estoque} m</td>
                                            <td class="pr-2"><span class="font-medium">Necessidade:</span></td>
                                            <td class="pr-4 text-gray-900 dark:text-gray-200">${necessidade} m</td>
                                            <td class="pr-2"><span class="font-medium">Saldo:</span></td>
                                            <td class="pr-4"><span class="${saldoClass}">${saldoFormatado} m</span></td>
                                            <td class="pr-2"><span class="font-medium">Produção possível:</span></td>
                                            <td><span class="font-semibold ${producaoPossivel > 0 ? 'text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-400'}">${producaoPossivel} unidades</span></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                ...
                if (htmlExistentes) {
                    finalHtml += `
                        <div class="mb-4">
                            <h4 class="text-sm font-medium text-green-700 dark:text-green-400 mb-2">Cores já cadastradas no produto:</h4>
                            ${htmlExistentes}
                        </div>
                    `;
                }
                ...
                if (htmlDisponiveis) {
                    finalHtml += `
                        <div class="mb-4">
                            <h4 class="text-sm font-medium text-blue-700 dark:text-blue-400 mb-2">Cores disponíveis nos tecidos:</h4>
                            ${htmlDisponiveis}
                        </div>
                    `;
                }
