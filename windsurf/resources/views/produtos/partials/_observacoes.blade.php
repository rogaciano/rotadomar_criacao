@php
    $canCreateProdutoObservacoes = auth()->user()->canCreate('produto_observacoes');
    $canDeleteProdutoObservacoes = auth()->user()->canDelete('produto_observacoes');
@endphp
...
<div class="bg-gray-50 dark:bg-slate-800/50 overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6">
    <div class="flex justify-between items-center mb-4">
        ...
        @if($canCreateProdutoObservacoes)
            <button type="button" onclick="abrirModalObservacao()" class="btn-ghost-purple">
            ...
            @foreach($observacoes as $obs)
                <div class="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:shadow-md transition">
                    <div class="flex justify-between items-start">
                        ...
                        @if($canDeleteProdutoObservacoes)
