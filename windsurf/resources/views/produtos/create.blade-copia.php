                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('produtos.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- ReferÃªncia -->
                            <div>
                                <label for="referencia" class="block text-sm font-medium text-gray-700 mb-1">ReferÃªncia</label>
                            ...
                            <!-- PreÃ§o Atacado -->
                            <div>
                                <label for="preco_atacado" class="block text-sm font-medium text-gray-700 mb-1">PreÃ§o Atacado (R$)</label>
                            ...
                            <!-- PreÃ§o Varejo -->
                            <div>
                                <label for="preco_varejo" class="block text-sm font-medium text-gray-700 mb-1">PreÃ§o Varejo (R$)</label>
                            ...
                            <!-- Ficha de ProduÃ§Ã£o -->
                            <div>
                                <label for="ficha_producao" class="block text-sm font-medium text-gray-700 mb-1">Ficha de ProduÃ§Ã£o</label>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Formatos aceitos: PDF, DOC, DOCX (mÃ¡x. 10MB)</p>
                            </div>

                            <!-- CatÃ¡logo de Vendas -->
                            <div>
                                <label for="catalogo_vendas" class="block text-sm font-medium text-gray-700 mb-1">CatÃ¡logo de Vendas</label>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateSelectOptions() {
                ...
                selects.forEach(select => {
                    ...
                    // Destruir a instÃ¢ncia Select2 antes de modificar as opÃ§Ãµes
                    ...
                    // Reinicializar Select2 apÃ³s modificar as opÃ§Ãµes
                    $(select).select2({
                        placeholder: "Selecione um tecido",
                        allowClear: true,
                        width: '100%'
