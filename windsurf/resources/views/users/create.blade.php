                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <label class="inline-flex items-center">
                                        ...
                                        <input type="checkbox" name="is_admin" id="is_admin" value="1" class="rounded border-gray-300 dark:border-slate-600 dark:bg-slate-800 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ old('is_admin') ? 'checked' : '' }}>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <label class="inline-flex items-center">
                                        ...
                                        <input type="checkbox" name="is_faccao" id="is_faccao" value="1" class="rounded border-gray-300 dark:border-slate-600 dark:bg-slate-800 text-orange-600 shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50" {{ old('is_faccao') ? 'checked' : '' }}>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select id="visualizacoes" name="visualizacoes[]" multiple class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 h-32">
                                    @foreach($localizacoes as $localizacao)
                                        <option value="{{ $localizacao->id }}" {{ in_array($localizacao->id, old('visualizacoes', [])) ? 'selected' : '' }}>
                                            {{ $localizacao->nome_localizacao }}
                                        </option>
                                    @endforeach
                                </select>
