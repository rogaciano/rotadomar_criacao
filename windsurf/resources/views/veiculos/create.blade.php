                ...
                <form method="POST" action="{{ route('veiculos.store') }}">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="placa" id="placa" value="{{ old('placa') }}" required maxlength="10"
                        ...
                        <div>
                            ...
                            <input type="text" name="descricao" id="descricao" value="{{ old('descricao') }}" maxlength="255"
