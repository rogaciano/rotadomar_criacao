            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <dl>
                                ...
                                <div class="bg-red-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dd class="mt-1 text-sm text-red-900 sm:mt-0 sm:col-span-2">
                                        {{ $tipo->deleted_at->format('d/m/Y H:i:s') }}
                                    </dd>
                                </div>
                                @endif
                            </dl>
                    ...
                    <div class="mt-6 flex space-x-3">
                        @if($tipo->trashed())
                            <form action="{{ route('tipos.restore', $tipo) }}" method="POST" class="inline">
                                @csrf
                                @method('POST')
                            ...
                            <form action="{{ route('tipos.force-delete', $tipo) }}" method="POST" class="inline" onsubmit="return confirm('Tem certeza que deseja excluir permanentemente este tipo? Esta ação não pode ser desfeita.');">
                                @csrf
                                @method('DELETE')
