    ...
    <div class="py-8 bg-slate-50 dark:bg-slate-950">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap gap-3 mb-6">
                <a href="{{ route('tipos.create') }}" class="btn-ghost-primary">
                        ...
                        <table class="table-base">
                            <thead class="table-header">
                                <tr>
                                    ...
                                    <th scope="col" class="table-header-cell">Ações</th>
                                </tr>
                            </thead>
                            <tbody class="table-body">
                                @forelse($tipos as $tipo)
                                    <tr class="{{ $tipo->trashed() ? 'table-row-trashed' : 'table-row' }}">
                                        ...
                                        <td class="table-cell">
                                            <span class="{{ $tipo->ativo ? 'badge-active' : 'badge-inactive' }}">
                                        ...
                                        <td class="table-cell">
                                            <div class="flex items-center space-x-2">
                                                <a href="{{ route('tipos.show', $tipo) }}" class="btn-action-view">
                                                ...
                                                @if(!$tipo->trashed())
                                                    <a href="{{ route('tipos.edit', $tipo) }}" class="btn-action-edit">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
