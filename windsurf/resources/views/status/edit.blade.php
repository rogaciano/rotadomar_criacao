                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('status.update', $status) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="descricao" id="descricao" value="{{ old('descricao', $status->descricao) }}" class="block mt-1 w-full border-gray-300 dark:border-slate-600 dark:bg-slate-800 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                        </div>

                        <div class="mb-4">
                            <label for="observacoes" class="block text-sm font-medium text-gray-700 mb-1">Observações</label>
                            <textarea name="observacoes" id="observacoes" rows="4" class="block mt-1 w-full border-gray-300 dark:border-slate-600 dark:bg-slate-800 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('observacoes', $status->observacoes) }}</textarea>
                        </div>
